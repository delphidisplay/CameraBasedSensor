...
def __parseArguments():
	...
	parser.add_argument("--input", default="camera", help="Type webcam for webcam, camera for default IP cameras, or video for video, add path  to camera if want different video")
